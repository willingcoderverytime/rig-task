...
impl<'a> DynClientBuilder {
    ...
    pub fn new() -> Self {
        ...
        .register_all(vec![
            ClientFactory::new(
                ...
                rig_ollama::client::Client::from_env_boxed,
                rig_ollama::client::Client::from_val_boxed,
            ),
            ClientFactory::new(
                DefaultProviders::DEEPSEEK,
                rig_deepseek::client::Client::from_env_boxed,
                rig_deepseek::client::Client::from_val_boxed,
            ),
        ])
    }
    ...
    pub async fn stream_chat(
        ...
        let request = CompletionRequest {
            ...
            additional_params: None,
            tool_choice: None,
            chat_history: rig::OneOrMany::many(history)
                .unwrap_or_else(|_| rig::OneOrMany::one(Message::user(""))),
        };
